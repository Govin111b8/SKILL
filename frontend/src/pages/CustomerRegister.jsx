...
function CustomerRegister() {
  ...
  return (
    <div className="role-register-page">
      <div className="role-register-visual role-customer">
        ...
        <div className="role-register-visual-content">
          <span className="rr-icon"><FiUser size={48} /></span>
          <h2>Join as a Customer</h2>
          <p>Create your account to discover and book skilled professionals near you.</p>
          <div className="rr-stats">
            <div className="rr-stat">
              <span className="rr-stat-value">5K+</span>
              <span className="rr-stat-label">Professionals</span>
            </div>
            <div className="rr-stat">
              <span className="rr-stat-value">25K+</span>
              <span className="rr-stat-label">Happy Clients</span>
            </div>
            <div className="rr-stat">
              <span className="rr-stat-value">4.8★</span>
              <span className="rr-stat-label">Avg Rating</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="role-register-form-side">
        <div className="role-register-card">
          <div className="role-login-badge customer">
            <FiUser size={14} /> Customer Registration
          </div>
          <h1>Create Account</h1>
          <p className="role-register-subtitle">Start booking professionals today</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="role-register-btn customer" disabled={loading}>
