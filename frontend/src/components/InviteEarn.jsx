...
function InviteEarn() {
  ...
  function handleWhatsAppShare() {
    const message = encodeURIComponent(
      `Hey! I've been using SkillConnect to find amazing professionals for home services. Use my code ${referralCode} to get ${reward} off your first booking! 🎉\n\n${inviteLink}`
    );
  ...
  return (
    <div className="invite-earn-card">
      <div className="invite-earn-header">
        <div className="invite-earn-icon">
          <FiGift size={24} />
        </div>
        <div>
          <h3>Invite Friends & Earn {reward}</h3>
          <p>Share your referral link. You both get {reward} when they complete their first booking!</p>
        </div>
      </div>
      ...
      <div className="invite-earn-stats">
        ...
        <div className="invite-stat invite-stat--earnings">
          <FiGift size={16} />
          <span>₹{user?.referral_earnings || 0} earned</span>
        </div>
      </div>
